...
git add lab3/practice1.py
git commit -m "lab3: complete practice 1"

# After finishing practice2.py
git add lab3/practice2.py
git commit -m "lab3: complete practice 2"

# After finishing practice3.py
git add lab3/practice3.py
git commit -m "lab3: complete practice 3"

```

When you are done with all practices, push your branch:
```bash
git push origin jsnow-lab3
```
...
```
https://github.com/<your-username>/<repo-name>/tree/jsnow-lab3
```
...
| 2 | **Correct branch & commits** | Branch must follow the `jsnow-lab3` naming format, and each practice must have its own separate commit |
